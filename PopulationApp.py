...
with st.container():
    ...
    country = st.selectbox('Select the Country (Start Typing to Search)',['India', 'United States', 'China', 'Pakistan',
 ...
 'Belgium':11, 'Bangladesh':12, 'Bulgaria':13, 'Bahrain':14, 'Bahamas':15, 'Belarus':16, 'Bermuda':17,
 'Bolivia':18, 'Brazil':19, 'Barbados':20, 'Bhutan':21, 'Botswana':22, 'Canada':23, 'Switzerland':24,
 'Channel Islands':25, 'Chile':26, 'China':27, 'Cameroon':28, 'Congo':29, 'Colombia':30, 'Comoros':31,
 ...
 'Estonia':49, 'Ethiopia':50, 'Finland':51, 'Fiji':52, 'France':53, 'Gabon':54, 'United Kingdom':55,
 'Georgia':56, 'Ghana':57, 'Gibraltar':58, 'Guinea':59, 'Gambia':60, 'Greece':61, 'Grenada':62,
 'Greenland':63, 'Guatemala':64, 'Guam':65, 'Hong Kong':66, 'Honduras':67, 'Croatia':68, 'Haiti':69,
 'Hungary':70, 'Indonesia':71, 'Isle of Man':72, 'India':73, 'Ireland':74,
 'Iran, Islamic Rep.':75, 'Iraq':76, 'Iceland':77, 'Israel':78, 'Italy':79, 'Jamaica':80, 'Jordan':81,
 'Japan':82, 'Kazakhstan':83, 'Kenya':84, 'Cambodia':85, 'South Korea':86, 'Kuwait':87, 'Lebanon':88,
 'Liberia':89, 'Libya':90, 'St. Lucia':91, 'Liechtenstein':92, 'Sri Lanka':93, 'Lesotho':94,
 'Lithuania':95, 'Luxembourg':96, 'Latvia':97, 'Macao':98, 'St. Martin':99, 'Morocco':100, 'Monaco':101,
 ...
 'Mauritania':113, 'Mauritius':114, 'Malawi':115, 'Malaysia':116, 'Namibia':117, 'New Caledonia':118,
 'Niger':119, 'Nigeria':120, 'Nicaragua':121, 'Netherlands':122, 'Norway':123, 'Nepal':124, 'Nauru':125,
 'New Zealand':126, 'Oman':127, 'Pakistan':128, 'Panama':129, 'Peru':130, 'Philippines':131, 'Palau':132,
 'Papua New Guinea':133, 'Poland':134, 'Puerto Rico':135, 'Portugal':136, 'Paraguay':137,
 'French Polynesia':138, 'Qatar':139, 'Romania':140, 'Russia':141, 'Rwanda':142, 'Saudi Arabia':143,
 'Sudan':144, 'Senegal':145, 'Singapore':146, 'Sierra Leone':147, 'El Salvador':148, 'San Marino':149,
 'Somalia':150, 'South Sudan':151, 'Suriname':152, 'Slovak Republic':153, 'Slovenia':154, 'Sweden':155,
 'Eswatini':156, 'Seychelles':157, 'Syria':158, 'Chad':159, 'Togo':160, 'Thailand':161, 'Tajikistan':162,
 'Turkmenistan':163, 'Tonga':164, 'Trinidad':165, 'Tunisia':166, 'Turkey':167, 'Tuvalu':168, 'Tanzania':169,
 'Uganda':170, 'Ukraine':171, 'Uruguay':172, 'United States':173, 'Uzbekistan':174, 'Venezuela':175,
 'British Virgin Islands':176, 'Virgin Islands (U.S.)':177, 'Vietnam':178, 'Vanuatu':179,
 'Samoa':180, 'Kosovo':181, 'Yemen':182, 'South Africa':183, 'Zambia':184, 'Zimbabwe':185, 'Gaza':186,
